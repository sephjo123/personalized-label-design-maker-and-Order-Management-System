    ...
    <header class="header">    
            <nav class="nav container flex">
                    ...
                    <div class="menu-content">
                            ...
                            <?php 
                                $user_id = $_SESSION['ID'];
                                $inbox = $conn->query("SELECT * FROM `order_form` where customer_id = '$user_id' && status = 'To Claim' ")->num_rows;
                                ?>
                                    ...
                                    <a href="to-claim-orders.php" class="nav-link">To Claim orders</a></li>
                    ...
                    <table class="content-table">
                        ...
                        <?php
                                        ...
                                        while($row = mysqli_fetch_assoc($result))
                                                {
                                            ?>
                                                <td><a href="view-customer-pending-order.php?id=<?= $row['ID']; ?>" class="btn btn-success button-update">view</a></td>    
