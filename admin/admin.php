...
if(isset($_POST['submit'])){
   ...
   mobile = '$nmobile', address = '$naddress' WHERE id= $admin_id ";
...
if(isset($_POST['nprof'])){
   ...
   $query = "UPDATE user_form SET profile_pic = '$target_file' WHERE id= $admin_id ";
   $query_run = mysqli_query($conn, $query);
...
?>
  ...
  <div id="calendarPopup" class="calendar-popup">
    <div class="calendar-container">
        ...
        <a href ="<?php echo $profile ?>" target="_blank"><img src="<?php echo $profile ?>" alt="" class="profile_pic2"></a>
      ...
      <div class="wrapper">
            ...
            <form action="admin.php"  method="post" enctype="multipart/form-data">
                  ...
                  <div class="image-container">
                     <a onclick="showCalendar()"><img src="<?php echo $profile ?>" alt="" class="profile_pic"></a> 
                  </div>
                  <br>
                  <br>
                  ...
                  <div class="form">
                     ...
                     <div class="inputfield">
                        ...
                        <input type="text" name="nfirst_name" value="<?php echo $fname ?>"  class="input" required>
                     </div>  
                     <div class="inputfield">
                        <label>Last Name:</label>
                        <input type="text" name="nlast_name" value="<?php echo $lname ?>" class="input" required>
                     </div>
                     <div class="inputfield">
                        <label>Email:</label>
                     ...
                     <div class="inputfield">
                        ...
                        <p> <a href="admin-update-password.php">Update password</a></p>
                     </div>
