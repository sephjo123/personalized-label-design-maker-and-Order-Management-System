...
<!-- Home Section -->
    ...
    <form method="GET" class="searchitem" >
        ...
        <div class="meu-text">
                ...
                <h2 class="section-title">Claimed</h2>
                    ...
                    <table class="content-table">
                        ...
                        <?php
                                        ...
                                        while($row = mysqli_fetch_assoc($result))
                                                {
                                            ?>
                                                <td><a href="view-customer-claimed-order.php?id=<?= $row['ID']; ?>" class="btn btn-success button-update">view</a></td>       
