...
<!-- Home Section -->
    ...
    <section class="section" id="edit">
        ...
        <div class="meu-text">
                ...
                <h2 class="section-title">To Claim Orders</h2>
                ...
                <div class="outer-wrapper">
                    ...
                    <table class="content-table">
                        ...
                        <?php
                                        ...
                                        {
                                            ?>
                                                <td><a href="view-to-claim-order.php?id=<?= $row['ID']; ?>" class="btn btn-success button-update">view</a></td>      
