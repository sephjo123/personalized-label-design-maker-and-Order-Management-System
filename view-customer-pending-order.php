...
{
$date = $_POST['date_canceled'];
$status_cancel = $_POST['status_c'];
$id = $_POST['cancel_id'];

    $sql = "UPDATE order_form SET status='$status_cancel' , date_order='$date', un_read = '1'  WHERE ID=$id;";
