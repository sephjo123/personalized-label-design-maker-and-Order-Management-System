...
if(!isset($_SESSION['user_name'])){
 ...
 $result = display_toClaim_order();

 if(isset($_POST['read'])){
    $user_id = $_POST['user_id'];
    $mark_as_read = $_POST['mark_as_read'];

    $select = "UPDATE order_form SET un_read = '$mark_as_read'  WHERE customer_id = '$user_id' && status = 'To Claim'";
    $query_run = mysqli_query($conn, $select);

    if($query_run){
            header('location:to-claim-orders.php');
    }
}
            ...
            <nav class="nav container flex">
                    ...
                    <div class="menu-content">
                            <ul class="menu-list flex">
                                    ...
                                    <li><a href="to-claim-orders.php" class="nav-link">To Claim</a></li>
                                    <li><a href="order-claimed.php" class="nav-link">Claimed</a></li>
...
<!-- Home Section -->
    ...
    <form method="GET" class="searchitem" >
        ...
        <div class="meu-text">
                ...
                <h2 class="section-title">To Claim</h2>
                        ...
                        <?php
                            ...
                            $conn = mysqli_connect('localhost','root','','chappy_db');
                                ...
                                if(isset($_GET['search-order']))
                                {
                                    ...
                                    $user_id = $_SESSION['ID'];
                                    $query = "SELECT * FROM order_form WHERE  CONCAT(custom_image, order_id, ref_num, payer_name, shape, size, material, qty, processing, payment_total_amount, date_order)  LIKE '%$filtervalue%' && customer_id = '$user_id' && status = 'To Claim' ";
                                    ...
                                    if(mysqli_num_rows($query_run) > 0 )
                                    {
                                        foreach($query_run as $items)
                                        {
                                            ?>
                                    <tr>
                                        <td><a href="view-orders.php?id=<?= $items['ID']; ?>" class="btn btn-success button-update">view</a></td>
                        ...
                        <?php
                                        ...
                                        while($row = mysqli_fetch_assoc($result))
                                            ...
                                            ?>
                                                ...
                                                <td><a href="view-orders.php?id=<?= $row['ID']; ?>" class="btn btn-success button-update">view</a></td>     
