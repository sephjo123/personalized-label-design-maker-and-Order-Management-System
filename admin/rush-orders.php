...
$search_Rushapproved_order_details = display_all_Rushapproved_order();
            ...
            <nav class="nav container flex">
                    ...
                    <div class="menu-content">
                            <ul class="menu-list flex">
                                    ...
                                    <li><a href="rush-orders.php" class="nav-link active-navlink">2 Business Days</a></li>
                                    <li><a href="all-approved-orders.php" class="nav-link">4 Business Days</a></li>
                ...
                <div class="outer-wrapper">
                    ...
                    <table class="content-table">
                        ...
                        <?php
                                        ...
                                        while($row = mysqli_fetch_array($search_Rushapproved_order_details))
                                        {
                                            ?>
                                                <td><a href="view-approved-orders.php?id=<?= $row['ID']; ?>" class="btn btn-success button-update">view</a></td>      
